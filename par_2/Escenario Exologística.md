...
Compuesta por capitales nacionales e internacionales (la empresa local Román Logística comenzó a integrarse al grupo en 2002), Exologística cuenta con más de 300.000 metros cuadrados de depósitos en la Argentina, Brasil y Uruguay, y pertenece al grupo ITL (International Trade Logistics), que opera en 28 terminales portuarias en 16 países. 
La empresa contaba con un sistema de gestión de almacén desde hacía 15 años —el software Warehouse Boss 5, de Computer Associated, una empresa que luego fue adquirida por Infor, que corría sobre plataforma IBM AS400—, pero el crecimiento en sus operaciones y el avance de la competencia los llevó a buscar una solución que les permitiese adaptarse a los cambios de la industria: brindar visibilidad y trazabilidad online y maximizar la productividad operativa, en un ambiente seguro, ágil y de alta disponibilidad de la información, ya que tienen operaciones 24x7. “Significó salir de un mundo de confort, ya que estábamos muy acostumbrados al otro sistema , cuenta Gustavo Castelló, IT Manager de Exologística. Y agrega: “Con el sistema anterior, para cualquier información que se necesitase había que armar un reporte, entrar a ver si estaba en la tabla y hacer un desarrollo; el nuevo WMS, en cambio, tiene un formato amigable, está desarrollado en entorno web, es intuitivo, gráfico y en cualquier momento se puede sacar un reporte . Además, la solución tiene embebida la aplicación de inteligencia de negocios Cognos, de IBM.
...
Ante la consulta de Information Technology, en RedPraire no formularon declaraciones sobre este proceso.
Pese a haber optado por Infor, Gustavo Castelló aclara que la continuidad con la marca no implicaba efectuar una migración más sencilla, sino que “era como tener que empezar de nuevo".

Así comenzó el proceso de implementación, que todavía continúa. Esto es así porque se trata de un sistema centralizado que cuenta con 100 licencias para usuarios concurrentes (cuya implementación se realizó en alrededor de seis meses), que además debe ser instalado y adaptado a las distintas unidades de negocios y clientes  (cada una de las cuales lleva, en promedio, alrededor de tres meses).

“Estas requieren un relevamiento sobre el modelo operativo, lo que implica realizar una parametrización del sistema, el desarrollo de eventuales customizaciones y la definición y el diseño de interfaces. A veces, incluso, es necesario incorporar infraestructura, como el agregado de RFID o de terminales de voice picking" , cuenta el CIO. “Luego se realizan pruebas parciales e integrales, y se desarrolla una extranet para que el cliente consulte en tiempo real los indicadores de gestión de su operación. Se capacita a los empleados y se concluye con la puesta en régimen y la estabilización del sistema", completa.
...
El centro de datos, además, está construido con una infraestructura de red con cableado Systimax categoría 6 y cuenta con un sistema de control de acceso biométrico, racks APC de 19", sistema de control de parámetros ambientales y de seguridad NetBotz, UPS de 50 Kva, grupo electrógeno propio y sistema de aire acondicionado de precisión APC.
